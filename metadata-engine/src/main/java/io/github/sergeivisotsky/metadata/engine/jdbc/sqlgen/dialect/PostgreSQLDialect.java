...
import io.github.sergeivisotsky.metadata.engine.jdbc.sqlgen.formatter.date.SQLDateFormatter;
import io.github.sergeivisotsky.metadata.engine.jdbc.sqlgen.formatter.datetime.SQLDateTimeFormatter;
import io.github.sergeivisotsky.metadata.engine.jdbc.sqlgen.formatter.time.SQLTimeFormatter;
 ...
 */
public class PostgreSQLDialect extends BaseSQLDialect {
    ...
    // as SQL support will grow will need a custom PostgreSQL specific things.
