 ...
 */
public interface NavigationMetadataDao {

    /**
     * Executes the main logic of navigation metadata retrieval.
     *
     * @param viewName view for which metadata is got.
     * @return metadata DTO.
     */
    Navigation getNavigationMetadata(String viewName);
}
