 ...
 */
public class MSSQLTimeFormatterTest {

    private final SQLFormatter formatter = new MSSQLTimeFormatter();
    ...
    public void shouldFormatWhereValueWithTimeProperly() {
        ...
        //then
        assertEquals("CONVERT(VARCHAR(6), '110003', 121) AS [HH:MI]", result);
    }
