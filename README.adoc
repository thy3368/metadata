...
[[getting_started]]
== Get started
To get started with a usage of metadata provider go to the following https://github.com/sergeivisotsky/metadata-preconfig[template repository]
...
<dependency>
    ...
    <artifactId>metadata-engine</artifactId>
</dependency>
----
...
following https://github.com/sergeivisotsky/metadata-provider-demo[repository]
